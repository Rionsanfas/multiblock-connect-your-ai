...
import { HeroHandsAnimation } from "./HeroHandsAnimation";
...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-background" style={{ paddingTop: "clamp(80px, 12vw, 128px)", paddingBottom: "clamp(48px, 6vw, 80px)" }}>
      ...
      {/* Hands Animation reaching toward AI */}
      <HeroHandsAnimation show={phase >= 1} />
      ...
      >
        {/* Hero content - centered with hands animation behind */}
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
          ...
          <p 
            className="text-muted-foreground max-w-lg mx-auto text-break"
            style={{ 
