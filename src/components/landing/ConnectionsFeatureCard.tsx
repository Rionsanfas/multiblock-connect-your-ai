    ...
    >
      ...
      <div className="relative w-full overflow-hidden rounded-t-[1rem]">
        ...
        <div className="relative w-full" style={{ aspectRatio: '4/5' }}>
          {/* Loading skeleton */}
          {!isLoaded && (
            <div className="absolute inset-0 bg-card animate-pulse rounded-t-[1rem]" />
          )}
      ...
      <div className="flex-1 flex flex-col p-4 sm:p-5 lg:p-6">
        ...
        <h3 className="font-semibold text-foreground text-base sm:text-lg lg:text-xl mb-2">
          Link Thoughts Instantly
        </h3>

        {/* Description - customer-focused copy */}
        <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
          Drag to connect AI blocks in seconds—watch context flow seamlessly between your ideas.
        </p>
      </div>
    </div>
  );
