...
export function PricingCard({
  ...
  return <div className={`premium-card-wrapper ${plan.highlight ? 'sm:scale-105 z-10' : ''} h-full`}>
      ...
      <div className="premium-card-content h-full p-3 sm:p-4 md:p-6 relative flex flex-col">
        {/* Badge */}
        ...
        {/* Key Stats */}
        <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6 p-2.5 sm:p-3 md:p-4 rounded-lg sm:rounded-xl bg-muted/20 border border-border/30">
          {/* Boards */}
