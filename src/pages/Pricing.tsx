                ...
                <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                  {individualPlans.map((plan) => (
                    <GlassCard
                      ...
                      variant="hover"
                      glow={plan.highlight}
                      className={`p-6 relative ${plan.highlight ? "ring-2 ring-primary/50" : ""}`}
                    >
                      {plan.badge && (
                        <div className={`absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 text-xs font-medium rounded-full ${
                          plan.highlight ? "bg-primary text-primary-foreground" : "bg-accent text-accent-foreground"
                        }`}>
                          {plan.badge}
                        </div>
                      )}
            ...
            <div className="mt-20">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                {boardAddons.map((addon) => (
                  <GlassCard key={addon.id} variant="hover" className="p-5 text-center">
