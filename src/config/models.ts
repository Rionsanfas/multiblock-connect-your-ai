...
export const MODEL_CONFIGS: ModelConfig[] = [
  ...
  { id: 'mistral-gan-flux', provider: 'mistral', name: 'Flux 1.1 Pro', type: 'image', description: 'High-quality Flux 1.1 Pro image generation.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.04, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_functions: false, speed: 'medium', quality: 'premium' },
  { id: 'flux-2-pro', provider: 'together', name: 'Flux 2 Pro', type: 'image', description: 'Advanced Flux 2 Pro image generation.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.05, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_functions: false, speed: 'medium', quality: 'premium' },
  { id: 'grok-imaginegan', provider: 'xai', name: 'Grok ImagineGAN', type: 'image', description: 'xAI Grok image generation.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.04, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_functions: false, speed: 'medium', quality: 'high' },
