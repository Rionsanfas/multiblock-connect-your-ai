...
export const MODEL_CONFIGS: ModelConfig[] = [
  ...
  // ===== Google Image Models =====
  { id: 'imagen-4.0-ultra', provider: 'google', name: 'Imagen 4.0 Ultra', type: 'image', description: 'Highest quality image generation.', context_window: 32000, max_output_tokens: 4096, input_cost_per_1k: 0.05, output_cost_per_1k: 0.1, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_audio: false, supports_functions: false, speed: 'slow', quality: 'premium' },
  { id: 'imagen-3', provider: 'google', name: 'Imagen 3', type: 'image', description: 'High-quality image generation.', context_window: 32000, max_output_tokens: 4096, input_cost_per_1k: 0.04, output_cost_per_1k: 0.08, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_audio: false, supports_functions: false, speed: 'medium', quality: 'high' },

  // ===== Google Video Models =====
  { id: 'veo-3.1', provider: 'google', name: 'Veo 3.1', type: 'video', description: 'Latest video generation model.', context_window: 32000, max_output_tokens: 4096, input_cost_per_1k: 0.1, output_cost_per_1k: 0.2, supports_vision: false, supports_image_generation: false, supports_video_generation: true, supports_audio: false, supports_functions: false, speed: 'slow', quality: 'premium' },
  { id: 'veo-3.1-fast', provider: 'google', name: 'Veo 3.1 Fast', type: 'video', description: 'Fast video generation.', context_window: 32000, max_output_tokens: 4096, input_cost_per_1k: 0.06, output_cost_per_1k: 0.12, supports_vision: false, supports_image_generation: false, supports_video_generation: true, supports_audio: false, supports_functions: false, speed: 'medium', quality: 'high' },

  // ===== xAI Models (Chat Only) =====
  ...
  // ===== Mistral Image Model =====
  { id: 'pixtral-large', provider: 'mistral', name: 'Pixtral Large', type: 'image', description: 'Vision and image understanding.', context_window: 128000, max_output_tokens: 8192, input_cost_per_1k: 0.002, output_cost_per_1k: 0.006, supports_vision: true, supports_image_generation: true, supports_video_generation: false, supports_audio: false, supports_functions: true, speed: 'medium', quality: 'high' },
  ...
  { id: 'flux-1-dev', provider: 'together', name: 'Flux.1 Dev', type: 'image', description: 'Development Flux model.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.025, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_audio: false, supports_functions: false, speed: 'medium', quality: 'high' },
  { id: 'flux-1.1-pro', provider: 'together', name: 'Flux 1.1 Pro', type: 'image', description: 'Professional Flux 1.1.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.04, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_audio: false, supports_functions: false, speed: 'medium', quality: 'premium' },
  { id: 'flux-1-kontext-pro', provider: 'together', name: 'Flux.1 Kontext Pro', type: 'image', description: 'Context-aware Flux.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.04, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_audio: false, supports_functions: false, speed: 'medium', quality: 'premium' },
  { id: 'flux-2-pro', provider: 'together', name: 'Flux.2 Pro', type: 'image', description: 'Latest Flux 2 model.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.055, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_audio: false, supports_functions: false, speed: 'medium', quality: 'premium' },
  { id: 'imagen-4.0-ultra-together', provider: 'together', name: 'Imagen 4.0 Ultra', type: 'image', description: 'Imagen via Together.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.05, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_audio: false, supports_functions: false, speed: 'medium', quality: 'premium' },

  // ===== Together.ai Video Models =====
  { id: 'veo-3.0', provider: 'together', name: 'Veo 3.0', type: 'video', description: 'Veo via Together.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.1, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: false, supports_video_generation: true, supports_audio: false, supports_functions: false, speed: 'slow', quality: 'premium' },
  { id: 'veo-3.0-fast-audio', provider: 'together', name: 'Veo 3.0 Fast + Audio', type: 'video', description: 'Fast Veo with audio.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.08, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: false, supports_video_generation: true, supports_audio: true, supports_functions: false, speed: 'medium', quality: 'high' },
  { id: 'kling-2.1-pro', provider: 'together', name: 'Kling 2.1 Pro', type: 'video', description: 'Kling video model.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.09, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: false, supports_video_generation: true, supports_audio: false, supports_functions: false, speed: 'slow', quality: 'premium' },
  { id: 'sora-2-pro-together', provider: 'together', name: 'Sora 2 Pro', type: 'video', description: 'Sora via Together.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.12, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: false, supports_video_generation: true, supports_audio: false, supports_functions: false, speed: 'slow', quality: 'premium' },
