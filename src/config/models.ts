...
export const MODEL_CONFIGS: ModelConfig[] = [
  ...
  { id: 'gemini-live-2.5-flash', provider: 'google', name: 'Gemini Live 2.5 Flash', type: 'chat', description: 'Real-time conversational Gemini.', context_window: 1000000, max_output_tokens: 8192, input_cost_per_1k: 0.00015, output_cost_per_1k: 0.0006, supports_vision: true, supports_image_generation: false, supports_video_generation: false, supports_audio: true, supports_functions: true, speed: 'fast', quality: 'high' },
  // Image Models
  ...
  { id: 'grok-4.0709', provider: 'xai', name: 'Grok 4.0709', type: 'chat', description: 'Grok 4 July 2024 release.', context_window: 131072, max_output_tokens: 8192, input_cost_per_1k: 0.002, output_cost_per_1k: 0.01, supports_vision: true, supports_image_generation: false, supports_video_generation: false, supports_audio: false, supports_functions: true, speed: 'medium', quality: 'high' },
  // Image Models
  ...
  { id: 'voxtral-small', provider: 'mistral', name: 'Voxtral Small', type: 'audio', description: 'Voice-to-text transcription.', context_window: 32000, max_output_tokens: 8192, input_cost_per_1k: 0.001, output_cost_per_1k: 0.003, supports_vision: false, supports_image_generation: false, supports_video_generation: false, supports_audio: true, supports_functions: false, speed: 'fast', quality: 'high' },
  { id: 'voxtral-mini', provider: 'mistral', name: 'Voxtral Mini', type: 'audio', description: 'Lightweight voice transcription.', context_window: 32000, max_output_tokens: 4096, input_cost_per_1k: 0.0005, output_cost_per_1k: 0.0015, supports_vision: false, supports_image_generation: false, supports_video_generation: false, supports_audio: true, supports_functions: false, speed: 'fast', quality: 'standard' },
  ...
  // Image Models
  { id: 'mistral-gan', provider: 'mistral', name: 'GAN', type: 'image', description: 'Mistral image generation.', context_window: 4096, max_output_tokens: 0, input_cost_per_1k: 0.02, output_cost_per_1k: 0, supports_vision: false, supports_image_generation: true, supports_video_generation: false, supports_audio: false, supports_functions: false, speed: 'medium', quality: 'high' },
